...
function cartReducer(state,action){
    switch (action.type) {
        case "Add to Cart":
            return {...state ,currentRestarunt :action.payload.restaurant, cartSize : state.cartSize + 1 , cartItem : [...state.cartItem,action.payload.item],totalCartValue:getCartValue(state)};
